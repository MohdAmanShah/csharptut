...
//Array.Sort(people, new PersonComparer());
//OutputPeopleName(people, "Final List of People");
...
//DV c = a + b;
//DV d = new();
//WriteLine($"x:{a.x}, y:{a.y}");
//WriteLine($"x:{b.x}, y:{b.y}");
//WriteLine($"x:{c.x}, y:{c.y}");
//WriteLine($"x:{d.x}, y:{d.y}");
//WriteLine($"Comparing two strucks {f.Equals(b)}");

//Point p = new Point() {x = 12, y = 23};
//Point q = new Point() {x = 12, y = 23};
//WriteLine($"Comparing two record structs {p == q}");
//WriteLine($"Comparing two record structs {q.Equals(p)}");
...
//    public int x;
//    public int y;
//    public DV(int xx, int yy)
//    {
//        x = xx;
//        y = yy;
//    }
//    public static DV operator +(DV v, DV w)
//    {
//        return new DV(v.x + w.x, v.y + w.y);
//    }
//}
...
//{
//    Name = "John Jones",
//    Born = new(2002, 7, 5, 0, 0, 0, TimeSpan.Zero),
//};
//john.EmployeeCode = "JJ012";
//john.HireDate = new(2014, 5, 19);

//Person johnPerson = john;
//john.WriteToConsole();
//johnPerson.WriteToConsole();

//WriteLine(john.ToString());
//WriteLine(johnPerson.ToString());

//Employee Em = (Employee)johnPerson;
//WriteLine(Em);

//try
//{
//    john.TimeTravel(when: new(2999, 12, 23));
//    john.TimeTravel(when: new(1950, 12, 24));
//}
//catch (PersonException ex)
//{
//    WriteLine(ex.Message);
...
WriteLine(StringExtensions.IsValidEmail(email1)); 
WriteLine(StringExtensions.IsValidEmail(email2)); 
WriteLine(StringExtensions.IsValidEmail(email3));

WriteLine(email1.IsValidEmail());
email1.ChangeString();
WriteLine(email1);